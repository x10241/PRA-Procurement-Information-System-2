            ...
            Try
                If slideFlaG = True Then
                    ...
                    If PNL_SLIDE Is APNL_ITEMINFO Then
                        If X_LOC < 270 Then
                            PNL_SLIDE.Location = New Point(270, 40)
                            X_LOC = 270
...
#Region "REPORT"
            ElseIf pb Is PB_INVENTORY_VIEW_REPORT Or llbl Is LLBL_INVENTORY_VIEW_REPORT Then
                Dim newApp As Form = FRM_INVENTORY_PRINT_PREVIEW.OpenProgram(FRM_INVENTORY_PRINT_PREVIEW)
                newApp.Location = New Point(0, 0)
                newApp.MdiParent = MDI_Mainform
                newApp.Text = "Inventory Report"
                newApp.Show()
#End Region
...
#Region "TEXTBOX CLICK"
    Private Sub WTXT_CUSTODIAN_NAME_Click(sender As Object, e As EventArgs) Handles WTXT_CUSTODIAN_NAME.Click, WTXT_PROPERTY_USER.Click
