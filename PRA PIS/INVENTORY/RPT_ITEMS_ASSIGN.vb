...
Public Class RPT_ITEMS_ASSIGN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_ITEMS_ASSIGN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ITEMS_ASSIGN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ITEMS_ASSIGN = New RPT_ITEMS_ASSIGN()
        rpt.Site = Me.Site
        Return rpt
    End Function
