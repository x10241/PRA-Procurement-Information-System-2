...
Public Class RPT_STICKER_TAG4x3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_STICKER_TAG4x3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_STICKER_TAG4x3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_STICKER_TAG4x3 = New RPT_STICKER_TAG4x3()
        rpt.Site = Me.Site
        Return rpt
    End Function
