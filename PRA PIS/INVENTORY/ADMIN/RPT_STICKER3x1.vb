...
Public Class RPT_STICKER3x1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_STICKER3x1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_STICKER3x1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_STICKER3x1 = New RPT_STICKER3x1()
        rpt.Site = Me.Site
        Return rpt
    End Function
