...
Public Class RPT_SLIP_DRAWING
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_SLIP_DRAWING.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_SLIP_DRAWING
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_SLIP_DRAWING = New RPT_SLIP_DRAWING()
        rpt.Site = Me.Site
        Return rpt
    End Function
