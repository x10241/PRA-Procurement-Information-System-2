...
Public Class RPT_ITEM_LIST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_ITEM_LIST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ITEM_LIST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ITEM_LIST = New RPT_ITEM_LIST()
        rpt.Site = Me.Site
        Return rpt
    End Function
