...
Public Class RPT_MARKETING_SLIP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_MARKETING_SLIP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_MARKETING_SLIP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_MARKETING_SLIP = New RPT_MARKETING_SLIP()
        rpt.Site = Me.Site
        Return rpt
    End Function
