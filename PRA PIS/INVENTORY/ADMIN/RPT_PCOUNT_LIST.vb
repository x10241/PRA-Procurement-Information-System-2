...
Public Class RPT_PCOUNT_LIST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_PCOUNT_LIST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PCOUNT_LIST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PCOUNT_LIST = New RPT_PCOUNT_LIST()
        rpt.Site = Me.Site
        Return rpt
    End Function
