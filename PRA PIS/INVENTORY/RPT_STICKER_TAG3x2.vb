...
Public Class RPT_STICKER_TAG3x2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_STICKER_TAG3x2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_STICKER_TAG3x2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_STICKER_TAG3x2 = New RPT_STICKER_TAG3x2()
        rpt.Site = Me.Site
        Return rpt
    End Function
