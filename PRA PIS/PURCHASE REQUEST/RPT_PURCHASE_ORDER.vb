...
Public Class RPT_PURCHASE_ORDER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRA_PIS.RPT_PURCHASE_ORDER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PURCHASE_ORDER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PURCHASE_ORDER = New RPT_PURCHASE_ORDER()
        rpt.Site = Me.Site
        Return rpt
    End Function
