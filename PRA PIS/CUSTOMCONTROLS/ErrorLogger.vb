...
Public Class ErrorLogger
    ...
    Public Sub WriteToErrorLog(ByVal msg As String, ByVal stkTrace As String, ByVal title As String)
        ...
        s1.Write("Date/Time: " & MDI_Mainform.LBLShowTime.Text & vbCrLf)
        s1.Write("System User: " & Trim(MDI_Mainform.LBLSystemUser.Text) & "IP ADDRESS: " & Net.Dns.GetHostEntry(Net.Dns.GetHostName).AddressList(0).ToString() & "  MACHINE: " & Net.Dns.GetHostName & vbCrLf)
